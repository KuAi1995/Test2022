...
import com.fulin.serverapplication.Book;
import com.fulin.serverapplication.IBookDispose;

/**
 * @Description MainActivity
 *
 * @Author FuLin
 * @Time 2022/4/15 23:40
 */
public class MainActivity extends AppCompatActivity {
    ...
    //定义aidl接口变量
    private IBookDispose mAIDLService;
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            //使用IBookDispose.Stub.asInterface()方法将传入的IBinder对象传换成了mAIDLService对象
            mAIDLService = IBookDispose.Stub.asInterface(service);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind_service2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "set book name: " + book.getName());
                try {
        ...
        bind_service3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.d(TAG, "get book name: " + book.getName());
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
            }
